...
namespace Player.AI
{
    ...
    internal class AiController : MonoBehaviour, IAiController
    {
        ...
        public AiContext AiContext => _context;
        ...
        private AiMovementStateMachine _stateMachine;
        ...
        private void Awake()
        {
            ...
            _context = new AiContext(
                inputHandler as IAiInputManager,
                this as IAiController,
                _collisionHandler,
                _settings,
                _animator,
                _spriteRenderer,
            ...
            _stateMachine = new AiMovementStateMachine(_settings, _context);
