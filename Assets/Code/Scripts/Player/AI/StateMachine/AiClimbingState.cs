...
{
    internal sealed class AiClimbingState : AiBaseState
    {

        private bool _jumpTriggered;
        private bool _isDetached;
        private float _attachTimer;
        public AiClimbingState(AiContext ctx, AiMovementStateMachine stateMachine) : base(ctx, stateMachine)
        {
        ...
        public override void Tick(float dt)
        {
            ...
            {
                stateMachine.ChangeState<AiVaultState>();
                return;
            }
            ...
            if (dot > 0f && _attachTimer <= 0f)
            {
                ...
                {
                    stateMachine.ChangeState<AiPrepareJumpState>();
                }
            }
