...
{
    internal abstract class AiBaseState
    {
    
        protected readonly AiContext ctx;
        protected readonly AiMovementStateMachine stateMachine;
        ...
        protected AiBaseState(AiContext ctx, AiMovementStateMachine stateMachine)
        {
           this.ctx = ctx;
        ...
        {
            //ends up called in AiController.FixedUpdate()
        }
